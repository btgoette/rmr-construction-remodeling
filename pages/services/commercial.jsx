...
export default function Commercials() {
    ...
    return (
        <>
                ...
                <Container>
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col lg={{ order: 1, span: 6 }}>
                            ...
                            <p>For over 30 years, Roseville Roofing has been the trusted choice for exceptional commercial roofing solutions. Whether you&rsquo;re managing a small retail shop or a large industrial facility, we deliver reliable, high-quality roofing services tailored to your business&rsquo;s unique needs.</p>
                        </Col>
                    </Row>
                </Container>
            </section>
                ...
                <Container>
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col lg={{ order: 0, span: 6 }}>
                            ...
                            <p>Roseville Roofing is proud to partner with a variety of industries, providing roofing solutions tailored to their specific needs:</p>
            ...
            <section>
                <Container>
                    <h2>Experience the<br /><span>Roseville Roofing Advantage</span></h2>
                    <div className="border-line-center"></div>
