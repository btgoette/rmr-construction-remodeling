        ...
        <>
                ...
                <Container>
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col lg={{ order: 1, span: 6 }}>
                            ...
                            <p>At Roseville Roofing, we have been proudly serving El Dorado, Placer, and Sacramento Counties since 1989. From Auburn to Carmichael, Citrus Heights to Rocklin, and beyond, we are the go-to solution for all your roofing needs.</p>
                        </Col>
                    </Row>
                </Container>
            </section>
                ...
                <Container>
                    ...
                    <Row className="align-items-center py-2">
                        ...
                        <Col lg={{ order: 0, span: 6 }}>
                            ...
                            <p>Northern California&rsquo;s unpredictable weather can wreak havoc on your roof. From strong winds to hailstorms, damage can happen when you least expect it. Roseville Roofing is here to help.</p>
                ...
                <Container>
                    ...
                    <Row className="align-items-center py-2">
                        ...
                        <Col lg={{ order: 1, span: 6 }}>
                            ...
                            <p>Don&rsquo;t wait for minor roof issues to turn into major roof repairs. Roseville Roofing offers free analyses and estimates to help you take charge of your roof&rsquo;s health. From routine roof maintenance to emergency roof repairs, we are here to provide reliable, long-lasting solutions.</p>
                        </Col>
                    </Row>
                </Container>
            </section>
            ...
            <section className="bg-home">
                <Container>
                    <Row className="align-items-center">
                        <Col lg={6}>
                            <h2 className="mt-0 text-start border-bottom">Call<br /> <span>Roseville Roofing!</span></h2>
                        </Col>
                        <Col lg={6}>
                            <p>Protect your home with expert roof repair services trusted by Northern California homeowners for over 30 years. Contact Roseville Roofing for a roof inspection, roof repair, or roof replacement, and experience roofing excellence you can count on!</p>
                            <p className="my-4">
                                <Button as={Link} href="tel:916-791-7348" variant="primary">Call Now</Button>
                            </p>
                        </Col>
                    </Row>
                </Container>
